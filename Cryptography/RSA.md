...
<span> $$ \text{If } \ p - q < n^{\frac{1}{4}} \ \text{ Fermat’s factoring algorithm can factor } n \text{ efficiently } $$ </span>
...
<span style="border-style: double; padding: 8px"> $$ n = pq = (\frac{q-p}{2})^2 - (\frac{q + p}{2})^2 = x^2 - y^2 $$ </span>

where 

<span> $$ x = \frac{q-p}{2} \ \ \text{ and } \ \ y = \frac{q + p}{2} $$ </span>
...
<span> $$ \text{Let } a = \sqrt{n} $$ </span>

<span> $$ \text{Let } b = a \times a - n $$ </span>

<span> $$ \text{While } b \text{ is not a perfect square } $$ </span>

* <span> $$ a = a + 1 $$ </span>

* <span> $$  b = a \times a - n$$ </span>

<span> $$ \text{Return } \ \ a - \sqrt{b} $$ </span>
